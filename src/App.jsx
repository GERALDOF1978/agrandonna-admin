      ...
      <main className={`flex-1 p-4 md:p-10 overflow-y-auto transition-colors duration-300 ${['pedidos','historico'].includes(aba) ? 'bg-gray-300' : 'bg-gray-50'}`}>
        ...
        {aba === 'sistema' && (
          <div className="max-w-2xl bg-white p-10 rounded-[50px] shadow-2xl border border-gray-100 space-y-6 mx-auto">
             ...
             {/* BLOCO DE CARDS DE PROMOÇÃO ATUALIZADO */}
             <div className="space-y-4 pt-4 border-t border-gray-100 bg-orange-50 p-6 rounded-3xl border border-orange-100">
                <h3 className="font-black text-xs text-orange-600 uppercase text-center mb-4 flex justify-center items-center gap-2"><Flame size={18}/> Exibir 6 Cards de Promoção no App</h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-orange-500 text-orange-600" value={cfg.precoPromoBroto} onChange={e => setCfg({ ...cfg, precoPromoBroto: parseFloat(e.target.value) })} placeholder="R$ 34.00"/>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-orange-500 text-orange-600" value={cfg.precoPromoGrande} onChange={e => setCfg({ ...cfg, precoPromoGrande: parseFloat(e.target.value) })} placeholder="R$ 47.90"/>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-orange-500 text-orange-600" value={cfg.precoPromoGigante} onChange={e => setCfg({ ...cfg, precoPromoGigante: parseFloat(e.target.value) })} placeholder="R$ 72.99"/>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-orange-500 text-orange-600" value={cfg.precoPromoMeioMetro} onChange={e => setCfg({ ...cfg, precoPromoMeioMetro: parseFloat(e.target.value) })} placeholder="R$ 52.90"/>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-orange-500 text-orange-600" value={cfg.precoPromoUmMetro} onChange={e => setCfg({ ...cfg, precoPromoUmMetro: parseFloat(e.target.value) })} placeholder="R$ 79.90"/>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <input type="number" step="0.01" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-black outline-none text-xs focus:border-pink-500 text-pink-600" value={cfg.precoPromoDoce} onChange={e => setCfg({ ...cfg, precoPromoDoce: parseFloat(e.target.value) })} placeholder="R$ 53.00"/>
                  </div>
                </div>
                
                {/* BOTÃO DE SALVAR BEM VISÍVEL */}
                <button onClick={async () => { await setDoc(doc(db, 'loja_config', 'geral'), cfg); alert('Promoções Salvas no App do Cliente!'); }} className="w-full bg-green-500 text-white py-4 rounded-2xl font-black uppercase shadow-lg hover:scale-95 transition-all mt-4 flex justify-center items-center gap-2">
                  <Save size={18}/> Salvar e Publicar Promoções
                </button>
             </div>
